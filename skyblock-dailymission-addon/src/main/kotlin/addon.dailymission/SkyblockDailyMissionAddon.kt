...
class SkyblockDailyMissionAddon : HwaSkyBlockAddon, Listener {
    ...
    private var missionCommand: IslandMissionCommand? = null
    private var reloadCommand: IslandMissionReloadCommand? = null
    ...
    override fun onDisable() {
        missionCommand?.let { cmd -> commandRegistrar?.unregister(cmd) }
        reloadCommand?.let { cmd -> commandRegistrar?.unregister(cmd) }
        missionCommand = null
        reloadCommand = null
    ...
    private fun registerCommands() {
        ...
        missionCommand = IslandMissionCommand(
            AddonConfig,
            missionService,
            dataStore,
            gui
        )
        registrar.register(missionCommand!!)

        reloadCommand = IslandMissionReloadCommand(
            AddonConfig,
            missionService,
            dataStore,
            registry,
