...
class hwaskyblock_skyblock_mysql {
    ...
    init {
        val sql = """
            CREATE TABLE IF NOT EXISTS hwaskyblock_skyblock (
                ...
                skyblock_point VARCHAR(50) NOT NULL,
    ...
    fun insertSkyblockDefault(id: String, skyblockName: String, skyblockLeader: String) {
        ...
        val sql = "INSERT INTO hwaskyblock_skyblock ($keys) VALUES ($placeholders) ON DUPLICATE KEY UPDATE $updates"
