...
class SkyblockCattleAddon : HwaSkyBlockAddon, Listener {
    ...
    fun openShop(player: Player) {
        ...
        val inv = Bukkit.createInventory(null, rows * 9, color(msg("gui.shop.title", defaultShopTitleRaw)))
    ...
    fun onShopClick(event: InventoryClickEvent) {
        if (event.view.title != color(msg("gui.shop.title", defaultShopTitleRaw))) return
        event.isCancelled = true
